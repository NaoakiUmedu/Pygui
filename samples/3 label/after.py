...
from omake import bbr as B


class Frame(Tk.Frame):
    def __init__(self, master=None):
        Tk.Frame.__init__(self, master)
        self.label = Tk.Label(self, text='click me!', width=32, height=2,
    ...
    def heating_start(self, event):
        self.temp = 1000
        self.label.configure(width=12, height=1, text='Hello world!', font=(
            'Helvetica', '24'), fg='black')
